...
이 실습을 마친 뒤 자연어 요청부터 승인까지의 전체 흐름은 [실습 3](03_Agent_Orchestration_Lab.md)에서 다룬다.
...
이 루프의 자동화 구현은 [실습 3](03_Agent_Orchestration_Lab.md)에서 다룬다.
...
| Agent 오케스트레이션 | [실습 3](03_Agent_Orchestration_Lab.md) 참조 |
